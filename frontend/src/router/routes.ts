...
export const routes: RouteRecordRaw[] = [
  ...
  { path: '/admin/tournaments/:id/registrations', redirect: (to) => `/tournaments/${String(to.params.id)}/manage/players`, meta: { requiresAdmin: true } },
  { path: '/admin/tournaments/:id/playoffs', redirect: (to) => ({ path: `/tournaments/${String(to.params.id)}/manage/matches`, query: { stage: 'playoff' } }), meta: { requiresAdmin: true } },
  { path: '/admin/tournaments/:id/:section(settings|players|matches|results|decks-report|notifications|audit)', redirect: (to) => `/tournaments/${String(to.params.id)}/manage/${String(to.params.section)}`, meta: { requiresAdmin: true } },
