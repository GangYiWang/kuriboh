...
const auditActionTypeText: Record<string, string> = {
  ...
  TOURNAMENT_ACCOUNTS_IMPORTED: '导入赛事账号',
  TOURNAMENT_ACCOUNTS_CARRIED_OVER_IN: '结转往届余号',
  TOURNAMENT_ACCOUNTS_CARRIED_OVER_OUT: '结转余号至新赛事',
  TOURNAMENT_ACCOUNT_CLAIMED: '领取赛事账号',
  TOURNAMENT_ACCOUNT_REPLACEMENT_REQUESTED: '提交换号申请',
  TOURNAMENT_ACCOUNT_REPLACEMENT_APPROVED: '通过换号申请',
  TOURNAMENT_ACCOUNT_REPLACEMENT_REJECTED: '拒绝换号申请',
  TOURNAMENT_ACCOUNT_REPLACEMENT_CLAIMED: '领取更换账号',
